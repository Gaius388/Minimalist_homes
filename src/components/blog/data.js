export const data = [
  ...
  },
  {
    ...
    details:
      "Have an ear to the ground on what real estate investors are acting on in the current market. CRE Online offers tips on avoiding common real estate mistakes, mastering rental properties, and choosing an investment strategy that’s right for you.",
  ...
  },
  {
    ...
    details:
      "Want to grow your appraisal skills and real estate career? McKissock is a great place to start. Learn about real estate tax laws, appraisals of specific home types like senior housing, and even how to balance parenting with a real estate career.",
  ...
  },
  {
    ...
    details:
      "Gathering leads, real estate marketing and personal branding, and even training opportunities -- Keller Williams’ Blog has it all. Get inspired with hand-curated TED Talks, learn about the latest in real estate regulation, and find out how to grow your business on this comprehensive blog.",
